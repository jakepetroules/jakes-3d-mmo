namespace MMO3D.CommonCode
{
    ...
    /// </summary>
    [Serializable]
    public sealed class OneHandedWeapon : OffensiveMunition
    {
        /// <summary>
        /// Initializes a new instance of the OneHandedWeapon class.
        /// </summary>
        ...
        /// <exception cref="System.ArgumentException">WeaponType is WeaponType1H.Undefined.</exception>
        public OneHandedWeapon(long itemTypeId, string name, string description, float weight, short integrity, short maximumIntegrity, byte integrityLevel, byte evasionBonus, byte attackBonus, int attackSpeed, WeaponType1H weaponType)
            : base(itemTypeId, ItemClass.OneHandedWeapon, name, description, weight, integrity, maximumIntegrity, integrityLevel, evasionBonus, attackBonus, attackSpeed)
        {
            if (weaponType == WeaponType1H.Undefined)
            {
                throw new ArgumentException("cannot be WeaponType1H.Undefined", "weaponType");
            }
        ...
        public WeaponType1H WeaponType
        {
            get;
            private set;
        }
